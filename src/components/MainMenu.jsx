...
const current=usePathname();
  ...
  return (
    <div className='mx-20'>
       <nav className='relative px-6 py-6 flex justify-items-end items-center bg-white'>
                <a className='text-3xl font-bold leading-none' href='#'>
                    <span>Design</span><span className='text-orange-400'>Agency</span>
                </a>
                ...
                <ul className='hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2  lg:flex lg:mx-30 lg:flex lg:items-center lg:w-auto lg:space-x-6'>
                    <li className=''>
                    ...
                    <li className='mb-1'>
                        <Link className='py-2 px-4 text-sm font-semibold border border-1 border-green-500 hover:bg-green-50 hover:text-green-600 rounded' href={'/login'}>Login</Link>
                    </li>
                    <li className='mb-1'>
                        <Link className='py-2 px-4 text-sm font-semibold bg-green-500 text-white hover:bg-green-400 hover:text-green-600 rounded' href={'/testimonials'}>Register</Link>
                    </li>
                </ul>
            </nav>
                ...
                <nav className='relative flex flex-col py-6 px-6 h-full w-full bg-white border-r overflow-y-auto'>
                    ...
                    <div>
                        <ul>
                            ...
                            <li className='mb-1'>
                                <Link className='block p-4 text-sm font-semibold border-green-600 hover:bg-green-50 hover:text-green-600 rounded' href={'/login'}>Login</Link>
                            </li>
                            <li className='mb-1'>
                                <Link className='block p-4 text-sm font-semibold text-gray-400 hover:bg-green-50 hover:text-green-600 rounded' href={'/testimonials'}>Register</Link>
                            </li>
                        </ul>
                    </div>
                </nav>
