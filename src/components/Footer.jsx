                ...
                <div className="container mx-auto px-4">
                  <div className="flex items-center justify-between my-10">
                    <div className='mx-10 w-1/3 text-white'>
                        <h1 className='px-10 my-5 text-4xl font-bold text-white'>WEB LOGO</h1>
                        <p className='px-10 font-normal'>Some footer text about the  Agency. Just a little description to help people understand you better</p>
                        <div className="px-10 mb-4 lg:mb-0 order-first lg:order-last mt-5">
                            <a className="inline-block mr-2 p-2 bg-green-500 hover:bg-gray-700 rounded-full" target="_blank" href=''>
                    ...
                    <div className=' mt-10 mx-10 w-1/3 text-white flex flex-col'>
                      ...
                      <Link className=" mr-2 p-1 text-md" target="_blank" href='/services'>
                        Services
                      </Link>
                      <Link className=" mr-2 p-1 text-md" target="_blank" href='/services'>
                        Portfolio
                    ...
                    <div className='px-20 w-1/3 text-white'>
                      ...
                      <p className='font-normal'>Design Agency Head Office.
Airport Road
